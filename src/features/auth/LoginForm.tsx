...
import { loginWithEmail, loginWithGoogle, loginWithGithub } from './authAPI';
...
export default function LoginForm() {
  ...
  const handleGithubLogin = async () => {
    try {
      ...
      setServerError('Unable to sign in with GitHub. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className='space-y-6'>
      ...
      <div className='space-y-3'>
        <button
          ...
          disabled={isLoading}
          className='flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-700 bg-slate-900 px-5 py-3 text-base font-semibold text-slate-100 transition hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed'
        >
